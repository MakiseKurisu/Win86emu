...
static const char DLL_NAME[]="user32.nt.dll";

DEFINE_FUNC2(SetShellWindowEx)
...
DEFINE_FUNC12(CreateWindowExA)
DEFINE_FUNC12(CreateWindowExW)
...
DEFINE_FUNC4(DdeInitializeA)
DEFINE_FUNC4(DdeInitializeW)
...
DEFINE_FUNC10(DrawStateA)
DEFINE_FUNC10(DrawStateW)
...
DEFINE_FUNC3(EnumChildWindows)
DEFINE_FUNC1(EnumClipboardFormats)
DEFINE_FUNC3(EnumDesktopWindows)
DEFINE_FUNC3(EnumDesktopsA)
DEFINE_FUNC3(EnumDesktopsW)
DEFINE_FUNC4(EnumDisplayDevicesA)
DEFINE_FUNC4(EnumDisplayDevicesW)
DEFINE_FUNC4(EnumDisplayMonitors)
...
DEFINE_FUNC2(EnumPropsA)
DEFINE_FUNC3(EnumPropsExA)
DEFINE_FUNC3(EnumPropsExW)
DEFINE_FUNC2(EnumPropsW)
DEFINE_FUNC3(EnumThreadWindows)
DEFINE_FUNC2(EnumWindowStationsA)
DEFINE_FUNC2(EnumWindowStationsW)
DEFINE_FUNC2(EnumWindows)
...
DEFINE_FUNC9(GrayStringA)
DEFINE_FUNC9(GrayStringW)
...
DEFINE_FUNC2(LoadAcceleratorsA)
DEFINE_FUNC2(LoadAcceleratorsW)
DEFINE_FUNC2(LoadBitmapA)
DEFINE_FUNC2(LoadBitmapW)
DEFINE_FUNC2(LoadCursorA)
DEFINE_FUNC1(LoadCursorFromFileA)
DEFINE_FUNC1(LoadCursorFromFileW)
DEFINE_FUNC2(LoadCursorW)
DEFINE_FUNC2(LoadIconA)
DEFINE_FUNC2(LoadIconW)
DEFINE_FUNC6(LoadImageA)
DEFINE_FUNC6(LoadImageW)
DEFINE_FUNC2(LoadKeyboardLayoutA)
DEFINE_FUNC2(LoadKeyboardLayoutW)
DEFINE_FUNC2(LoadMenuA)
DEFINE_FUNC1(LoadMenuIndirectA)
DEFINE_FUNC1(LoadMenuIndirectW)
DEFINE_FUNC2(LoadMenuW)
DEFINE_FUNC4(LoadStringA)
DEFINE_FUNC4(LoadStringW)
...
DEFINE_FUNC1(RegisterClassA)
DEFINE_FUNC1(RegisterClassExA)
DEFINE_FUNC1(RegisterClassExW)
DEFINE_FUNC1(RegisterClassW)
...
DEFINE_FUNC6(SendMessageCallbackA)
DEFINE_FUNC6(SendMessageCallbackW)
...
DEFINE_FUNC2(SetWindowsHookA)
DEFINE_FUNC4(SetWindowsHookExA)
DEFINE_FUNC4(SetWindowsHookExW)
DEFINE_FUNC2(SetWindowsHookW)
...
DEFINE_FUNC2(UnhookWindowsHook)
...
DEFINE_FUNC_(wsprintfA)
DEFINE_FUNC_(wsprintfW)
