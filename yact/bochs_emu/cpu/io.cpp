/////////////////////////////////////////////////////////////////////////
// $Id: io.cc,v 1.81 2010/03/14 15:51:26 sshwarts Exp $
/////////////////////////////////////////////////////////////////////////
//
...
unsigned int ProcessCallback(unsigned int _eax, unsigned int _eip);
void BX_CPP_AttrRegparmN(1) BX_CPU_C::IN_EAXIb(bxInstruction_c *i)
{
  ...
  if(port==0xe5)
	RAX = ProcessCallback(gen_reg[BX_32BIT_REG_EAX].dword.erx,gen_reg[BX_32BIT_REG_EIP].dword.erx-2);
  else
    RAX = BX_INP(port, 4);
}
