/////////////////////////////////////////////////////////////////////////
// $Id: access32.cc,v 1.31 2011/01/04 16:17:20 sshwarts Exp $
/////////////////////////////////////////////////////////////////////////
//
...
BX_CPU_C::read_virtual_dword_32(unsigned s, Bit32u offset)
{
  ...
  return *(Bit32u*)laddr;
#if 0
  if (1 /*seg->cache.valid & SegAccessROK*/ ) {
    if (1 /*offset < (seg->cache.u.segment.limit_scaled-2)*/) {
accessOK:
      unsigned tlbIndex = BX_TLB_INDEX_OF(laddr, 3);
#if BX_SUPPORT_ALIGNMENT_CHECK && BX_CPU_LEVEL >= 4
      Bit32u lpf = AlignedAccessLPFOf(laddr, (3 & BX_CPU_THIS_PTR alignment_check_mask));
...
{
  *(Bit8u*)(BX_CPU_THIS_PTR address_xlation.paddress1)=val8;
  return;
...
{
  *(Bit16u*)(BX_CPU_THIS_PTR address_xlation.paddress1)=val16;
  return;
  if (BX_CPU_THIS_PTR address_xlation.pages > 2) {
    // Pages > 2 means it stores a host address for direct access.
...
{
  *(Bit32u*)(BX_CPU_THIS_PTR address_xlation.paddress1)=val32;
  return;
  if (BX_CPU_THIS_PTR address_xlation.pages > 2) {
    // Pages > 2 means it stores a host address for direct access.
