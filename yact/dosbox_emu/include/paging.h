...
#define mem_readb_inline(a) host_readb((HostPt)(a))
#define mem_readw_inline(a) host_readw((HostPt)(a))
#define mem_readd_inline(a) host_readd((HostPt)(a))
#define mem_writeb_inline(a,b) host_writeb((HostPt)(a),(b))
#define mem_writew_inline(a,b) host_writew((HostPt)(a),(b))
#define mem_writed_inline(a,b) host_writed((HostPt)(a),(b))

#define mem_readb_checked(a,v) ((*(v)=host_readb((HostPt)(a))),0)
#define mem_readw_checked(a,v) ((*(v)=host_readw((HostPt)(a))),0)
#define mem_readd_checked(a,v) ((*(v)=host_readd((HostPt)(a))),0)
#define mem_writeb_checked(a,b) (host_writeb((HostPt)(a),(b)),0)
#define mem_writew_checked(a,b) (host_writew((HostPt)(a),(b)),0)
#define mem_writed_checked(a,b) (host_writed((HostPt)(a),(b)),0)
