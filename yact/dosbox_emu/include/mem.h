...
#define mem_readb(a) host_readb((HostPt)(a))
#define mem_readw(a) host_readw((HostPt)(a))
#define mem_readd(a) host_readd((HostPt)(a))
#define mem_writeb(a,b) host_writeb((HostPt)(a),(b))
#define mem_writew(a,b) host_writew((HostPt)(a),(b))
#define mem_writed(a,b) host_writed((HostPt)(a),(b))
