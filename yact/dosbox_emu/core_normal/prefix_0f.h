 ...
 */
	...
	CASE_0F_B(0x31)												/* RDTSC */
		...
		break;
	CASE_0F_W(0x40)												/* CMOVO Gd,Ed */
		MovCondw(TFLG_O);break;
	CASE_0F_W(0x41)												/* CMOVNO Gd,Ed */
		MovCondw(TFLG_NO);break;
	CASE_0F_W(0x42)												/* CMOVNO Gd,Ed */
		MovCondw(TFLG_B);break;
	CASE_0F_W(0x43)												/* CMOVNB Gd,Ed */
		MovCondw(TFLG_NB);break;
	CASE_0F_W(0x44)												/* CMOVZ Gd,Ed */
		MovCondw(TFLG_Z);break;
	CASE_0F_W(0x45)												/* CMOVNZ Gd,Ed */
		MovCondw(TFLG_NZ);break;
	CASE_0F_W(0x46)												/* CMOVBE Gd,Ed */
		MovCondw(TFLG_BE);break;
	CASE_0F_W(0x47)												/* CMOVNBE Gd,Ed */
		MovCondw(TFLG_NBE);break;
	CASE_0F_W(0x48)												/* CMOVS Gd,Ed */
		MovCondw(TFLG_S);break;
	CASE_0F_W(0x49)												/* CMOVNS Gd,Ed */
		MovCondw(TFLG_NS);break;
	CASE_0F_W(0x4a)												/* CMOVP Gd,Ed */
		MovCondw(TFLG_P);break;
	CASE_0F_W(0x4b)												/* CMOVNP Gd,Ed */
		MovCondw(TFLG_NP);break;
	CASE_0F_W(0x4c)												/* CMOVL Gd,Ed */
		MovCondw(TFLG_L);break;
	CASE_0F_W(0x4d)												/* CMOVNL Gd,Ed */
		MovCondw(TFLG_NL);break;
	CASE_0F_W(0x4e)												/* CMOVLE Gd,Ed */
		MovCondw(TFLG_LE);break;
	CASE_0F_W(0x4f)												/* CMOVNLE Gd,Ed */
		MovCondw(TFLG_NLE);break;
