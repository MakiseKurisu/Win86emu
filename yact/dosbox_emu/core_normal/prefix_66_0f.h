 ...
 */
	...
	CASE_0F_D(0x03)												/* LSL Gd,Ew */
		...
		break;
	CASE_0F_D(0x40)												/* CMOVO Gd,Ed */
		MovCondd(TFLG_O);break;
	CASE_0F_D(0x41)												/* CMOVNO Gd,Ed */
		MovCondd(TFLG_NO);break;
	CASE_0F_D(0x42)												/* CMOVNO Gd,Ed */
		MovCondd(TFLG_B);break;
	CASE_0F_D(0x43)												/* CMOVNB Gd,Ed */
		MovCondd(TFLG_NB);break;
	CASE_0F_D(0x44)												/* CMOVZ Gd,Ed */
		MovCondd(TFLG_Z);break;
	CASE_0F_D(0x45)												/* CMOVNZ Gd,Ed */
		MovCondd(TFLG_NZ);break;
	CASE_0F_D(0x46)												/* CMOVBE Gd,Ed */
		MovCondd(TFLG_BE);break;
	CASE_0F_D(0x47)												/* CMOVNBE Gd,Ed */
		MovCondd(TFLG_NBE);break;
	CASE_0F_D(0x48)												/* CMOVS Gd,Ed */
		MovCondd(TFLG_S);break;
	CASE_0F_D(0x49)												/* CMOVNS Gd,Ed */
		MovCondd(TFLG_NS);break;
	CASE_0F_D(0x4a)												/* CMOVP Gd,Ed */
		MovCondd(TFLG_P);break;
	CASE_0F_D(0x4b)												/* CMOVNP Gd,Ed */
		MovCondd(TFLG_NP);break;
	CASE_0F_D(0x4c)												/* CMOVL Gd,Ed */
		MovCondd(TFLG_L);break;
	CASE_0F_D(0x4d)												/* CMOVNL Gd,Ed */
		MovCondd(TFLG_NL);break;
	CASE_0F_D(0x4e)												/* CMOVLE Gd,Ed */
		MovCondd(TFLG_LE);break;
	CASE_0F_D(0x4f)												/* CMOVNLE Gd,Ed */
		MovCondd(TFLG_NLE);break;
