...
PageHandler * MEM_GetPageHandler(Bitu phys_page) {
	...
	return &ram_page_handler;	// yacht: assume that RAM is everywhere &illegal_page_handler;
}
...
public:	
	MEMORY(Section* configuration):Module_base(configuration){
		...
		Bitu memsize=2048;// In Windows we can address low 2 Gb of address space //;section->Get_int("memsize");
#if 0	
...
// TODO: check why memory is corrupted!!!
//	if(test)
//		delete test;
}
